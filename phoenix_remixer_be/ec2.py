from aws_cdk import aws_ec2, aws_iam, core
...
class AwsEc2:
    ...
    def __init__(
        ...
        subnet_type: aws_ec2.SubnetType = aws_ec2.SubnetType.PUBLIC,
        instance_type: aws_ec2.InstanceType = aws_ec2.InstanceType("t3.nano"),
    ) -> None:
        self.scope = scope
        ...
        return aws_ec2.Vpc(
            ...
            subnet_configuration=[
                aws_ec2.SubnetConfiguration(
                    name=self.subnet_type.value.lower(),
